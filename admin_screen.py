...
def run_sub(): os.system('python windows\\subjects.py')
def run_fac(): os.system('python windows\\faculty.py')
def run_stud(): os.system('python windows\\student.py')
def run_sch(): os.system('python windows\\scheduler.py')
def run_tt_s(): os.system('python windows\\timetable_stud.py')
def run_tt_f(): os.system('python windows\\timetable_fac.py')
